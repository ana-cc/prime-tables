...
class PrimeGrid():
    ...
    def __init__(self, grid_size):
        ...
        self.grid = [[None for x in range(self.grid_size + 1)]
                     for y in range(self.grid_size + 1)]

        # initializes sieve for this grid after finding the input that is required
        sieve_input = self.find_limit(self.grid_size)
        self.sieve = SieveOfEratosthenes(sieve_input)

    def find_limit(self, total_primes):
    ...
    def display_grid(self):
        ...
        # pretty printing for smaller grids
        # adds 5 digit padding and centers number
        print('\n'.join([
